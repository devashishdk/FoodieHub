...
public class ProfileActivity extends AppCompatActivity {
    ...
    private TextView mName,mMobile,mHostel,mRoom;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRoom = (TextView) findViewById(R.id.room_text);
        mHostel = (TextView) findViewById(R.id.hostel_text);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(!image.equals("default")) {
                    ...
                    Picasso.with(ProfileActivity.this).load(image).networkPolicy(NetworkPolicy.OFFLINE)
                            .placeholder(R.drawable.logo).into(mDisplayImage, new Callback() {
                        @Override
