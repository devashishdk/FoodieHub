...
public class AllShopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(AllShopActivity.this);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId())
                {
                    case (R.id.home):
                        ...
                        Intent intent = new Intent(AllShopActivity.this,AllShopActivity.class);
                    ...
                    case (R.id.contact):
                        drawerLayout.closeDrawers();
                        Intent intent2 = new Intent(AllShopActivity.this,LoginActivity.class);
                        startActivity(intent2);
                        //overridePendingTransition(R.anim.slide_in_right,R.anim.slide_out_left);
                        break;
                    case (R.id.profile):
                        drawerLayout.closeDrawers();
                        Intent intentPro = new Intent(AllShopActivity.this,ProfileActivity.class);
                        startActivity(intentPro);
                        //overridePendingTransition(R.anim.slide_in_right,R.anim.slide_out_left);
                        break;
                    case (R.id.Orders):
                        drawerLayout.closeDrawers();
                        Intent intentOrder = new Intent(AllShopActivity.this,OrdersActivity.class);
        ...
        dbProducts.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.exists()){
                    ...
                    shopAdapter = new ShopAdapterSmall(AllShopActivity.this, ShopList);
        ...
        dbCategories.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.exists()){
                    ...
                    categoryAdapter = new CategoriesAdapter(AllShopActivity.this, CategoryList);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case (R.id.logout):
                ...
                Intent intent = new Intent(AllShopActivity.this,LoginActivity.class);
                startActivity(intent);
                finish();
                break;
            case (R.id.settings):
                drawerLayout.closeDrawers();
                Intent intentP = new Intent(AllShopActivity.this,ProfileActivity.class);
    ...
    public void onStart() {
        ...
        {
            pd.dismiss();
            Intent startIntent = new Intent(AllShopActivity.this,LoginActivity.class);
